...
ggplot()+
  geom_line(data = updated_data[2400:2617,],aes(x=updated_data$date[2400:2617],y=updated_data$na_seasplit_interpolation[2400:2617],color="interpolation")) +
  geom_line(data = updated_data[2400:2617,],aes(x=updated_data$date[2400:2617],y=updated_data$pm25[2400:2617],color="pm25")) 
...
# close look at 62 NA in a row at the end of the series
ggplot()+
  geom_line(data = updated_data[2400:2617,],aes(x=updated_data$date[2400:2617],y=updated_data$na_seasplit_kalman[2400:2617],color="kalman")) +
  geom_line(data = updated_data[2400:2617,],aes(x=updated_data$date[2400:2617],y=updated_data$pm25[2400:2617],color="pm25")) 
...
# close look at 62 NA in a row at the end of the series
ggplot()+
  geom_line(data = updated_data[2400:2617,],aes(x=updated_data$date[2400:2617],y=updated_data$na_seasplit_locf[2400:2617],color="locf")) +
  geom_line(data = updated_data[2400:2617,],aes(x=updated_data$date[2400:2617],y=updated_data$pm25[2400:2617],color="pm25")) 
...
# close look at 62 NA in a row at the end of the series
ggplot()+
  geom_line(data = updated_data[2400:2617,],aes(x=updated_data$date[2400:2617],y=updated_data$na_seasplit_ma[2400:2617],color="ma")) +
  geom_line(data = updated_data[2400:2617,],aes(x=updated_data$date[2400:2617],y=updated_data$pm25[2400:2617],color="pm25")) 
...
ggplot()+
  ...
  labs(title=paste("PM2.5 Predictions for Next",336,"observation",sep = " ") ,x ="Day", y = "PM2.5") +
  labs(color = "LINE")+
